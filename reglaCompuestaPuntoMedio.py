...
raiz = Tk()
raiz.title("Calculadora WmU Regla Compuesta Punto Medio")
...
#Titulo
titulo = Label(raiz,text="Método de la Regla Compuesta Punto Medio", font=("Impact",20), fg="tan", bg="black")
titulo.pack(pady=20)
...
eFuncion = Entry(raiz,width=40, highlightbackground="tan")
...
eValorLS = Entry(raiz,width=40, highlightbackground="tan")
...
eValorLI = Entry(raiz,width=40, highlightbackground="tan")
...
def calcular():
    try:
        ...
        resp = Label(ventana_resultado,text="Respuesta", font=("Times New Roman",16,"bold"), bg="black", fg="tan")
        resp.pack(pady=25)
        ...
        boton_cerrar = Button(ventana_resultado, text="Cerrar", command=ventana_resultado.destroy, fg="black", bg="tan")
...
boton = Button(raiz, text="Calcular", command=calcular, bg="tan")
boton.pack(pady=25)
